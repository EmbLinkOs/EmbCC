...
| `aarch64-elf` / `aarch64-emblink` | ELF, EMBX | Second architecture | **Done, early.** `aarch64-emblink` likewise. Own backend and AAPCS64; 191/191 its own suite; referee `aarch64-elf-gcc` 16.2 under QEMU `virt` |
