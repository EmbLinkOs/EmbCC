/* Generated by tools/gen-predef.sh from `x86_64-elf g++ 16.2.0 -std=gnu++20 -dM -E`,
   less the macros claiming C++ features EmbCC does not implement yet
   (EXCLUDE_CXX). Do not edit by hand; rerun the script. */

#include "../predef.h"

const struct predef_macro predef_macros_cxx_x86_64[] = {
    { "_LP64", "1" },
    { "__ATOMIC_ACQUIRE", "2" },
    { "__ATOMIC_ACQ_REL", "4" },
    { "__ATOMIC_CONSUME", "1" },
...
const int predef_macro_count_cxx_x86_64 =
    (int)(sizeof predef_macros_cxx_x86_64 / sizeof predef_macros_cxx_x86_64[0]);
