/* Generated by tools/gen-predef.sh from `aarch64-elf g++ 16.2.0 -std=gnu++20 -dM -E`,
   less the macros claiming C++ features EmbCC does not implement yet
   (EXCLUDE_CXX). Do not edit by hand; rerun the script. */

#include "../predef.h"

const struct predef_macro predef_macros_cxx_aarch64[] = {
    { "_LP64", "1" },
    { "__AARCH64EL__", "1" },
    ...
    { "__WINT_WIDTH__", "32" },
    { "__aarch64__", "1" },
    { "__arm_in(...)", "[[arm::in(__VA_ARGS__)]]" },
    { "__arm_inout(...)", "[[arm::inout(__VA_ARGS__)]]" },
    { "__arm_locally_streaming", "[[arm::locally_streaming]]" },
    { "__arm_new(...)", "[[arm::new(__VA_ARGS__)]]" },
    { "__arm_out(...)", "[[arm::out(__VA_ARGS__)]]" },
    { "__arm_preserves(...)", "[[arm::preserves(__VA_ARGS__)]]" },
    { "__arm_streaming", "[[arm::streaming]]" },
    { "__arm_streaming_compatible", "[[arm::streaming_compatible]]" },
    { "__cplusplus", "202002L" },
};

const int predef_macro_count_cxx_aarch64 =
    (int)(sizeof predef_macros_cxx_aarch64 / sizeof predef_macros_cxx_aarch64[0]);
