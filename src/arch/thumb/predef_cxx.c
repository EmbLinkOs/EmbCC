/* Generated by tools/gen-predef.sh from `thumbv7m-unknown-none-eabi clang++ 23.1.0 -std=gnu++20 -dM -E`,
   less the macros claiming C++ features EmbCC does not implement yet
   (EXCLUDE_CXX). Do not edit by hand; rerun the script. */

#include "../predef.h"

const struct predef_macro predef_macros_cxx_thumb[] = {
    { "_GNU_SOURCE", "1" },
    { "_ILP32", "1" },
    { "__APCS_32__", "1" },
    { "__ARMEL__", "1" },
    ...
    { "__CLANG_ATOMIC_CHAR8_T_LOCK_FREE", "2" },
...
const int predef_macro_count_cxx_thumb =
    (int)(sizeof predef_macros_cxx_thumb / sizeof predef_macros_cxx_thumb[0]);
