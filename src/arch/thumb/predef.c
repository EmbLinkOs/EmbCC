/* Generated by tools/gen-predef.sh from `thumbv7m-unknown-none-eabi clang 23.1.0 -dM -E`.
   Do not edit by hand; rerun the script (ARCHITECTURE.md §5). */

#include "../predef.h"

const struct predef_macro predef_macros_thumb[] = {
    { "_ILP32", "1" },
    { "__APCS_32__", "1" },
    { "__ARMEL__", "1" },
    { "__ARM_32BIT_STATE", "1" },
    ...
    { "__FLT16_NORM_MAX__", "6.5504e+4F16" },
...
const int predef_macro_count_thumb =
    (int)(sizeof predef_macros_thumb / sizeof predef_macros_thumb[0]);
